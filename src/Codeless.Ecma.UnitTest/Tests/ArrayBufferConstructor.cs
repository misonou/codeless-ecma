...
namespace Codeless.Ecma.UnitTest.Tests {
  public class ArrayBufferConstructor : TestBase {
    ...
    public void IsView(RuntimeFunction isView) {
      ...
      EcmaValue DV = new ClassLiteral(Extends(DataView)) { ["constructor"] = FunctionLiteral(DerivedCtor) };
      ...
      TestWithTypedArrayConstructors(ctor => {
        EcmaValue TA = new ClassLiteral(Extends(ctor)) { ["constructor"] = FunctionLiteral(DerivedCtor) };
